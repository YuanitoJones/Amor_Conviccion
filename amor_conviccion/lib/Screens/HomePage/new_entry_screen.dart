...
void initState() {
  super.initState();
    _videoPlayerController = VideoPlayerController.network("https://firebasestorage.googleapis.com/v0/b/amor-y-conviccion.appspot.com/o/videos%2Fpresentacion.mp4?alt=media&token=245cd1ce-e40e-4ce1-b4a6-2f519db3220a")
      ...
      body: SafeArea(
        ...
        children: [
          Padding(
            ...
            child: Text("Bienvenido al programa Pentágono!", style: TextStyle(fontSize: size.width*0.05),),
          ),
          SizedBox(
